...
INSERT INTO www.translation  VALUES ('_methodology p1','Elcano Global Presence Index studies the global presence of a selection of 70 countries: the first 60 world economies according to World Bank data (nations with the highest GDP in current US dollars) as well as countries that are smaller in their economic size but are members of the Organisation for Economic Cooperation and Development (OECD) and/or the European Union','El Índice Elcano de presencia global cubre una selección de 70 países. Éstos son las primeras 60 economías mundiales según datos del Banco Mundial (países con mayor PIB en dólares corrientes), además de los países con menor tamaño económico miembros de la Organización para la Cooperación y el Desarrollo Económico (OCDE) y/o de la Unión Europea');
INSERT INTO www.translation  VALUES ('_methodology países h6','Countries listed in the Elcano Global Presence Index','Lista de países del Índice Elcano de Presencia Global');
INSERT INTO www.translation  VALUES ('_methodology países p','We should note that by making calculations at time intervals that go back to 1990, the intention of the project is to show the ‘two-bloc world’, even if in decline. Thus, Russia’s 1990 values refer to those of the Soviet Union, those of Germany to the German Federal Republic, those of the Czech Republic to Czechoslovakia, and those of Slovenia to Yugoslavia','Por último, en relación a la selección de países, hay que tener en cuenta que al calcularse calas temporales que se remontan a 1990, la intención del proyecto es la de mostrar el ‘mundo de los dos bloques’ –aunque sea en su ocaso–. De este modo, los valores de 1990 de Rusia se refieren, evidentemente, a los de la Unión Soviética, los de Alemania a la República Federal Alemana, los de la República Checa a Checoslovaquia, y los de Eslovenia a Yugoslavia');

INSERT INTO www.translation  VALUES ('_methodology criterios lista',
'Several criteria guided the select	ion of the variables that define the index:</p>
<ul class="util">
...
<li>Likewise, as for any other index, the best explanatory capacity is sought with the fewest number of variables or indicators possible. Finally, hard data on presence are taken, and not data based on judgments or opinions.</li>
	...
	'La selección de las variables para la elaboración de este índice se basa en una serie de criterios:<ul class="util">
...
INSERT INTO www.translation  VALUES ('_methodology criterios lista pie p',
'The three areas –economic, military and soft presence– do not contribute to the global presence of countries in the same way. In defining the weightings of each of the elements included in the Index, we conducted a survey with a panel of experts in international relations. The panel was selected based on the report <a href=''http://gotothinktank.com/'' target=''_blank''>The Global Go To Think Tanks published annually by the University of Pennsylvania.</a>The questionnaire was sent to 45 institutions in the United States, 40 in Europe, 27 in Asia, 17 in Latin America, 12 in Africa, eight in the Middle East and North Africa, and three in Oceania',
...
INSERT INTO www.translation  VALUES ('La incorporación de la Unión Europea al Índice Elcano de Presencia Global','La incorporación de la Unión Europea al Índice Elcano de Presencia Global','The inclusion of the European Union in the Elcano Global Presence Index');

INSERT INTO www.translation  VALUES ('_methodology incorporación UE p','Moreover, since 2012, the Index also measures the global presence of the European Union as a whole. The latter is complemented by the Elcano European Presence Index, which evaluates the internationalisation of member states within the Union’s boundaries','Desde el 2012 el Índice Elcano de Presencia Global calcula además para la Unión Europea de los 27. Este ejercicio trata de cuantificar la proyección global de la Unión, como si se tratase de un supuesto súper-estado con identidad propia, medición que se complementa con el Índice Elcano de Presencia Europea que por el contrario evalúa la presencia de los países miembros dentro del perímetro de la Unión');

INSERT INTO www.translation  VALUES ('Variables, Indicadores y fuentes del Índice Elcano de Presencia Global calculado para la Unión Europea','Variables, indicators and sources of the Elcano Global Presence Index calculated for the European Union','Variables, Indicadores y fuentes del Índice Elcano de Presencia Global calculado para la Unión Europea');
INSERT INTO www.translation  VALUES ('Para más Información sobre la metodología del Índice Elcano de Presencia Global, véase','For more details on the methodology, see','Para más Información sobre la metodología del Índice Elcano de Presencia Global, véase');

INSERT INTO www.translation  VALUES ('_methodology más información lista','<ul class=''util''>

<li>Iliana Olivié and Ignacio Molina, 2012, 
	<a href=''http://www.realinstitutoelcano.org/wps/portal/!ut/p/c5/04_SB8K8xLLM9MSSzPy8xBz9CP0os3jjYB8fnxBnR19TE2e_kEAjV2NDAwgAykdiyvs5GcDk8ev288jPTdUvyI0oBwDY0u0I/dl3/d3/L0lDU0lKSWdra0EhIS9JTlJBQUlpQ2dBek15cUEhL1lCSlAxTkMxTktfMjd3ISEvN18zU0xMTFRDQU01NENOVFEyN0YzMDAwMDAwMA!!/?WCM_PORTLET=PC_7_3SLLLTCAM54CNTQ27F30000000000000_WCM&WCM_GLOBAL_CONTEXT=/wps/wcm/connect/elcano/Elcano_in/Zonas_in/DT9-2012'' target=''_blank''>
...
<li>Iliana Olivié and Manuel Gracia, 2013, 
	<a href=''http://www.realinstitutoelcano.org/wps/portal/web/rielcano_en/contenido?WCM_GLOBAL_CONTEXT=/elcano/elcano_in/zonas_in/dt12-2013-olivie-gracia-iepg-metodologia-methodology-2012#.U2oBUVdNH1U'' target=''_blank''>
...
<li>Iliana Olivié and Ignacio Molina (coord.), 2011, 
	<a href=''http://www.realinstitutoelcano.org/wps/wcm/connect/8aaf13804739471481169f00526b8882/EstudioElcano2-english_IEPG_Olivie_Molina.pdf'' target=''_blank''>Elcano Global Presence Index (IEPG)</a>
...
<li>Iliana Olivié y Manuel Gracia 2013, 
	<a href=''http://www.realinstitutoelcano.org/wps/portal/rielcano/contenido?WCM_GLOBAL_CONTEXT=/elcano/elcano_es/especiales/indiceelcanopresenciaglobal/dt12-2013-olivie-gracia-iepg-metodologia-methodology-2012'' target=''_blank''>
		IEPG 2012: metodología y nuevos elementos para el análisis
	</a>
	, Documento de Trabajo del Real Instituto Elcano (DT) 12/2013
</li>
<li>Iliana Olivé e Ignacio Molina, 2012,
	<a href=''http://www.realinstitutoelcano.org/wps/portal/rielcano/contenido?WCM_GLOBAL_CONTEXT=/elcano/elcano_es/zonas_es/cooperacion+y+desarrollo/dt9-2012'' target=''_blank''>
...
<li>Iliana Olivié e Ignacio Molina (coord.), 2011, 
	<a href=''#'' target=''_blank''>Índice Elcano de Presencia Global (IEPG)</a>
	, Estudio Elcano 2, (Madrid: Real Instituto Elcano). </li>
</ul>');

INSERT INTO www.translation  VALUES ('Variables, Indicadores y fuentes del Índice Elcano de Presencia Europea','','Variables, Indicadores y fuentes del Índice Elcano de Presencia Europea');
INSERT INTO www.translation  VALUES ('_methodology tabla IEPG',
...
Corrective variable: European audience at the World Cup Final and the opening ceremony of the Olympic Games</td>
                                <td>FIFA and ICO Reports by Kantar Media and Nielsen</td>
                            </tr>
                            <tr>
                                <td>Culture</td>
                            ...
                            <tr>
                                <td>Science</td>
                                <td>Number of European articles published in the fields of the arts and humanities, social sciences and sciences</td>
    ...
    <tr>
        <td>Deportes</td>
        <td>Suma ponderada de los puntos en la clasificación mundial FIFA y del medallero en los juegos olímpicos de verano para cada EM de la UE
Variable correctora: audiencia europea de la final del mundial y de la ceremonia de apertura de los Juegos Olímpicos''</td>
        <td>Federación Internacional de Fútbol Asociación (FIFA) y Comité Olímpico Internacional (COI)
Informes de Kantar Media y Nielsen</td>
    </tr>
    <tr>
        <td>Cultura</td>
    ...
    <tr>
        <td>Tecnología</td>
        <td>Patentes orientadas al exterior por el total de países miembros de la UE: número de solicitudes de patentes relacionadas entre sí depositadas en uno o más países extranjeros para proteger la misma invención
Variable correctora: patentes registradas por cada país miembro en otros estados miembros. </td>
        <td>Organización Mundial de la Propiedad Intelectual (OMPI)– StatisticsDatabase</td>
    </tr>
    <tr>
        <td>Ciencia</td>
        <td>Número de artículos europeos publicados en los ámbitos de artes y humanidades, ciencias sociales y ciencias</td>
        <td>Thomson Reuters – Web of Knowledge</td>
    </tr>
    <tr>
        <td>Educación</td>
...
INSERT INTO www.translation  VALUES ('_methodology tabla IEPE',
'<table class=''data''>
                            ...
                            <tr>
                                <td>Culture</td>
                                <td>Exports of audiovisual services (cinematographic productions, radio and television programmes, and musical recordings)</td>
	...
	,'<table class=''data''>
                            ...
                            <tr>
                                <td>Ciencia</td>
                                <td>Número de artículos publicados en los ámbitos de artes y humanidades, ciencias sociales y ciencias</td>
                                <td>Thomson Reuters – Web of Knowledge</td>
                            </tr>
                            <tr>
                                <td>Educación</td>
