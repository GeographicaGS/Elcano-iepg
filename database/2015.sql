...
UPDATE iepg_data_redux.iepg_comment set comment='<p>América Latina se compone de los países de esta región para los que existe cálculo de presencia global. La presencia global del bloque se obtiene mediante la suma de la presencia global de cada país.</p><p>Los países que forman parte de él son Argentina, Brasil, Chile, Colombia, México, Perú, Venezuela, Costa Rica, República Dominicana, Guatemala y Uruguay. Representan en conjunto el 93,9% del PIB regional y 90,5% de la población latinoamericana (según datos de 2015 del Banco Mundial).</p>' WHERE code='XBLA' AND language='es';


UPDATE iepg_data_redux.iepg_comment set comment='<p>Asia-Pacífico se compone de los países de esta región para los que existe cálculo de presencia global. La presencia global del bloque se obtiene mediante la suma de la presencia global de cada país.</p><p>Los países que forman parte de él son Australia, Bangladesh, China, Filipinas, India, Indonesia, Japón, Malasia, Nueva Zelanda, Pakistán, República de Corea, Singapur, Tailandia, Vietnam, Myanmar, Sri Lanka, Kazajistán, Turkmenistán y Uzbekistán. Representan el 95,6% y el 94,5% del PIB y de la población de la región, respectivamente (según datos de 2015 del Banco Mundial).</p>' WHERE code='XBAP' AND language='es';

UPDATE iepg_data_redux.iepg_comment set comment='<p>Magreb y Oriente se compone de los países de esta región para los que existe cálculo de presencia global. La presencia global del bloque se obtiene mediante la suma de la presencia global de cada país</p><p>Los países que forman parte de él son Arabia Saudí, Argelia, Catar, Egipto, Emiratos Árabes Unidos, Irán, Iraq, Israel, Kuwait, Libia, Marruecos, Siria y Omán. Representan el 91,7 % del PIB regional (según datos de 2015 del Banco Mundial) y el 87% de su población, tomando la misma fuente.</p>' WHERE code='XBMM' AND language='es';

UPDATE iepg_data_redux.iepg_comment set comment='<p>África Sub-Sahariana se compone de los países de esta región para los que existe cálculo de presencia global; esto es, Angola, Nigeria, Sudáfrica, Etiopía, Kenia, Tanzania y Sudán. La presencia global del bloque se obtiene mediante la suma de la presencia global de cada país.</p><p>Se trata del bloque geográfico menos representativo de los que se incluyen en el índice puesto que los siete países considerados representan tan sólo 74,2% del PIB regional y 50,1% de su población (según datos de 2015 del Banco Mundial).</p>' WHERE code='XBSA' AND language='es';

UPDATE iepg_data_redux.iepg_comment set comment='<p>Europa, como bloque, se compone de todos los países que forman parte de la región (sean o no estados miembros de la Unión Europea) para los que existe cálculo de presencia global. La presencia global del bloque se obtiene mediante la mera suma de la presencia global de cada país que conforma el bloque.</p><p>Los países que forman parte del bloque Europa son Alemania, Austria, Azerbaiyán, Bélgica, Bielorrusia, Bulgaria, Chipre, Croacia, Dinamarca, Eslovaquia, Eslovenia, España, Estonia, Finlandia, Francia, Grecia, Hungría, Irlanda, Islandia, Italia, Letonia, Lituania, Luxemburgo, Malta, Noruega, Países Bajos, Polonia, Portugal, Reino Unido, República Checa, Rumanía, Rusia, Suecia, Suiza, Turquía y Ucrania.</p><p>Los países europeos considerados para el índice Elcano de presencia global representan el 98,8% del PIB regional y el 95,3% de su población, según datos de 2013 del Banco Mundial.
</p>' WHERE code='XBE2' AND language='es';


UPDATE iepg_data_redux.iepg_comment set comment='<p>Latin America is constituted by the countries in the region whose global presence has been included in the calculation. The bloc’s global presence is obtained by adding the global presence of each country of which it is comprised.</p><p>The countries that make up the bloc are Argentina, Brazil, Chile, Cuba, Colombia, Ecuador, Mexico, Peru, Venezuela, Costa Rica, Dominican Republic, Guatemala and Uruguay. They account for 93.9 % of the Latin America’s GDP and 90.5% of its population (according to World Bank data for 2015).</p>' WHERE code='XBLA' AND language='en';

UPDATE iepg_data_redux.iepg_comment set comment='<p>Asia-Pacific is constituted by the countries in the region for which their global presence has been calculated. The global presence of the block is obtained by the pure sum of the global presence of each country that makes up the block.</p><p>The countries comprising the bloc are Australia, Bangladesh, China, India, Indonesia, Japan, Malaysia, New Zealand, Pakistan, the Philippines, the Republic of Korea, Singapore, Sri Lanka, Thailand, Vietnam, Myanmar, Kazakhstan, Turkmenistan and Uzbekistan. They account for 95.6% and 94.5% of the region’s GDP and population, respectively (according to World Bank data for 2015).</p>' WHERE code='XBAP' AND language='en';

UPDATE iepg_data_redux.iepg_comment set comment='<p>The Maghreb and the Middle East are made up of the countries forming the region whose global presence has been calculated. The bloc’s global presence is the result of the pure sum of the global presence of each country comprising it.</p><p>The countries considered are Algeria, Egypt, Iran, Iraq, Israel, Kuwait, Libya, Morocco, Oman, Qatar, Saudi Arabia, Syria and the United Arab Emirates. They account for 91.7% of the region’s GDP and 87% of its population (according to World Bank data for 2015).</p>' WHERE code='XBMM' AND language='en';

UPDATE iepg_data_redux.iepg_comment set comment='<p>Sub-Saharan Africa comprises the countries in the region whose global presence has been calculated: Angola, Nigeria, South Africa, Sudan, Ethiopia, Kenya and Tanzania. The bloc’s global presence is obtained by adding the global presence of each country considered.</p><p>It is the Index’s least representative geographical bloc as the seven countries evaluated account for only 74.2% of the region’s GDP and 50.1% of its population (according to World Bank 2015 data).</p>' WHERE code='XBSA' AND language='en';

UPDATE iepg_data_redux.iepg_comment set comment='<p>Europe, as a bloc, is considered to comprise all the countries in the region (regardless of whether they are member states of the European Union) whose global presence has been calculated. The bloc’s global presence is obtained by adding up the result for each of its constituent countries.</p><p>The countries that make up the European bloc are Austria, Azerbaijan, Belarus, Belgium, Bulgaria, Croatia, Cyprus, the Czech Republic, Denmark, Estonia, Finland, France, Germany, Greece, Hungary, Iceland, Ireland, Italy, Latvia, Lithuania, Luxembourg, Malta, the Netherlands, Norway, Poland, Portugal, Romania, Russia, Slovakia, Slovenia, Spain, Sweden, Switzerland, Turkey, the Ukraine and the United Kingdom.</p><p>The European countries considered for the Elcano Global Presence Index account for 98.8% of the region’s GDP and 95.3 % of its population (according to World Bank data for 2013).</p>' WHERE code='XBE2' AND language='en';

update maplex.name set name='Sub-Saharan Africa' where name='Subsaharan Africa';
