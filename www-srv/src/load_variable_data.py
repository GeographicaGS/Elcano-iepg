...
for k,v in const.variableNames["iepg"].iteritems():
    ...
    var.populateFromTable("iepg_data_redux.iepg_data", "date_in", "date_out", "code", v["column"])
...
for k,v in const.variableNames["iepe"].iteritems():
    ...
    var.registerInDatabase()
    var.createVariableTable()
    var.populateFromTable("iepg_data_redux.iepe_data", "date_in", "date_out", "code", v["column"])
...
for k,v in const.variableNames["iepe_individual_contribution"].iteritems():
    ...
    var.registerInDatabase()
    var.createVariableTable()
    var.populateFromTable("iepg_data_redux.iepe_individual_contribution", "date_in", "date_out", "code", 
                          v["column"])
...
for k,v in const.variableNames["iepe_quota"].iteritems():
    ...
    var.registerInDatabase()
    var.createVariableTable()
    var.populateFromTable("iepg_data_redux.iepe_quota", "date_in", "date_out", "code", v["column"])
...
for k,v in const.variableNames["iepe_relative_contribution"].iteritems():
    ...
    var.registerInDatabase()
    var.createVariableTable()
    var.populateFromTable("iepg_data_redux.iepe_relative_contribution", "date_in", "date_out", "code", 
                          v["column"])
...
for k,v in const.variableNames["iepg_individual_contribution"].iteritems():
    ...
    var.registerInDatabase()
    var.createVariableTable()
    var.populateFromTable("iepg_data_redux.iepg_individual_contribution", "date_in", "date_out", "code", 
                          v["column"])
...
for k,v in const.variableNames["iepg_quota"].iteritems():
    ...
    var.registerInDatabase()
    var.createVariableTable()
    var.populateFromTable("iepg_data_redux.iepg_quota", "date_in", "date_out", "code", v["column"])
...
for k,v in const.variableNames["iepg_relative_contribution"].iteritems():
    ...
    var.registerInDatabase()
    var.createVariableTable()
    var.populateFromTable("iepg_data_redux.iepg_relative_contribution", "date_in", "date_out", "code", 
                          v["column"])
