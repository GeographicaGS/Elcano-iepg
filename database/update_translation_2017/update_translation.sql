...
INSERT INTO translation VALUES ('Países más UE', 'Countries + EU', 'Países + UE');
...
INSERT INTO translation VALUES ('Cuotas de presencia', 'Evolution of global presence quotas', 'Evolución de cuotas de presencia');
INSERT INTO translation VALUES ('resultados', 'results', 'Resultados');
INSERT INTO translation VALUES ('Bloques', 'Blocs', 'Bloques');
INSERT INTO translation VALUES ('_faq title 6', 'Does it measure merely the ‘quantity’ of a country’s presence or also its nature?', '¿Mide sólo la ‘cantidad’ de presencia o también su naturaleza?');
...
INSERT INTO translation VALUES ('Investigador', 'Analyst', 'Investigador');
INSERT INTO translation VALUES ('_faq title 3', 'Does it reflect the effort of countries attempting to achieve greater internationalization?', '¿Refleja el esfuerzo de un país por internacionalizarse?');
...
INSERT INTO translation VALUES ('_faq title 8', 'How are variables combined into a synthetic index?', '¿Y cómo se agregan en un índice sintético?');
...
INSERT INTO translation VALUES ('_faq text 11', 'To reveal transformations in the world order since the Cold War ended', 'Para poder mostrar los cambios en el orden mundial desde el final de la Guerra Fría');
INSERT INTO translation VALUES ('_faq title 14', 'Can the presence of European countries be combined, and can it be assumed that this is the presence of the European Union?', '¿Se puede agregar la presencia de los países europeos y asumir que es la de la Unión Europea?');
...
INSERT INTO translation VALUES ('_faq title 11', 'Why those years?', '¿Por qué esos años?');
...
INSERT INTO translation VALUES ('Seleccionar todos los bloques', 'Select all blocs', 'Seleccionar todos los bloques');
...
INSERT INTO translation VALUES (' Ranking de bloque %d', 'Bloc ranking %d', 'Ranking de bloque %d');
...
INSERT INTO translation VALUES ('_faq title 9', 'What about missing cases? How are they estimated?', '¿Hay casos perdidos? ¿Cómo se estiman?');
INSERT INTO translation VALUES ('Deseleccionar todos los bloques', 'Unselect all the blocs', 'Deseleccionar todos los bloques');
...
INSERT INTO translation VALUES ('_methodology p1', 'This year’s edition covers the global presence of a selection of 100 countries. The selection includes the first 92 world economies according to World Bank data (nations with the highest GDP in current US dollars in 2014) as well as countries that are smaller in their economic size but are members of the Organisation for Economic Cooperation and Development (OECD) and/or the European Union', 'El Índice Elcano de presencia global cubre una selección de 100 países. Éstos son las primeras 92 economías mundiales según datos del Banco Mundial (países con mayor PIB en dólares corrientes), además de los países con menor tamaño económico miembros de la Organización para la Cooperación y el Desarrollo Económico (OCDE) y/o de la Unión Europea');
...
INSERT INTO translation VALUES ('_name ', NULL, NULL);
INSERT INTO translation VALUES ('Seguir leyendo', 'Read more', 'Seguir leyendo');
INSERT INTO translation VALUES ('seguir leyendo', 'read more', 'seguir leyendo');
INSERT INTO translation VALUES ('Presencia global', 'Global presence', 'Presencia global');
INSERT INTO translation VALUES ('Contribución de presencia', 'Presence contribution', 'Contribución de presencia');
INSERT INTO translation VALUES ('Análisis', 'Analysis', 'Análisis');
INSERT INTO translation VALUES ('Datos básicos del país', 'Country''s basic data', 'Datos básicos del país');
INSERT INTO translation VALUES ('Presencia europea', 'European presence', 'Presencia europea');
INSERT INTO translation VALUES ('Presencia global / europea', 'Global / european presence', 'Presencia global / europea');
INSERT INTO translation VALUES ('Ver referencia', 'See reference', 'Ver referencia');
INSERT INTO translation VALUES (' Con filtro %d', 'With filter %d', 'Con filtro %d');
INSERT INTO translation VALUES ('Si no es debido a ninguno de los puntos anteriores consulte la ayuda de la herramienta, pulsando la &apos;?&apos; de información de la esquina superior derecha', NULL, NULL);
INSERT INTO translation VALUES ('_privacity body', '<p>(*) The English version will soon be available. We apologise for any inconvenience and we appreciate your understanding.</p>
...
queda informado y presta su consentimiento a la incorporación de sus datos personales a

un fichero automatizado propiedad de la Fundación Real Instituto Elcano de Estudios

Internacionales y Estratégicos. </p>

<p>Los datos, cuya confidencialidad queda garantizada, no se recogen sin su

consentimiento ni se ceden a terceros, y están siendo tratados e incorporados a los

correspondientes ficheros automatizados que están debidamente inscritos en el Registro

General de Protección de Datos. Serán utilizados por el Real Instituto Elcano con la

finalidad de remitir las publicaciones digitales, otros documentos e informes realizados

por esta institución, así como información relativa a las actividades del mismo. </p>

<p>
Igualmente, de conformidad con lo establecido en el art. 5 de la Ley Orgánica 15/1999,

de Protección de Datos de Carácter Personal (LOPD) y en la normativa de desarrollo,

queda informado de la posibilidad de ejercer, conforme a dicha normativa, los derechos

de acceso, rectificación, cancelación y oposición ante el Real Instituto. Para ejercitar

estos derechos podrá dirigir la oportuna solicitud enviando un correo electrónico bajo el

encabezamiento “PROTECCIÓN DE DATOS” a la dirección

<strong>bbdd[arroba]rielcano.org</strong>, o por correo postal a la dirección:<br/>
...
INSERT INTO translation VALUES ('Copyright TEXT', '2014 - 2017 &copy; Elcano Royal Institute ', '2014 - 2017 &copy; Real Instituto Elcano');
INSERT INTO translation VALUES ('_home IEPG explora desc', 'The <a class=\"nostyle\" href=\"%s\"><strong>Elcano Global Presence Index</strong></a> is an annual measurement of the projection in the world of 100 countries based on three dimensions:', 'El <a class=\"nostyle\" href=\"%s\"><strong>Índice Elcano de Presencia Global</strong></a> calcula anualmente la proyección de 100 países fuera de sus fronteras en función de tres dimensiones:');
INSERT INTO translation VALUES ('_faq text 9', 'In these cases we have also referred to expert opinion. A total of 2,440 data items have been estimated from 36,475 observations. The number of estimations accounts for 6.7 % of the base', 'Para ello, se ha recurrido al criterio del experto. Se han estimado 2.440 datos de un total de 36.475 observaciones. El número de estimaciones asciende a 6,7% de la base');
INSERT INTO translation VALUES ('_faq text 12', 'The Elcano Global Presence Index is calculated for 100 countries: the first 92 world economies and the countries not listed in these positions that are nonetheless members of the OECD or the European Union', 'El Índice Elcano de Presencia Global se calcula para 100 países: las primeras 92 economías mundiales y los países que, sin encontrarse entre estas primeras posiciones, son miembros de la OCDE y/o de la Unión Europea');
INSERT INTO translation VALUES ('_legal body', '<p>(*) The English version will soon be available. We apologise for any inconvenience and we appreciate your understanding.</p>
...
Madrid (España). El Real Instituto Elcano es titular de los derechos de propiedad

intelectual sobre las publicaciones, imágenes, textos, diseños, animaciones, o cualquier

otro contenido o elementos de esta Web, o dispone de los permisos necesarios para su

utilización. </p>

<p>Las publicaciones y contenidos incluidos en la Web se facilitan únicamente a usuarios

finales. Queda prohibida la reproducción sin reconocimiento expreso de los créditos a

los respectivos autores de las publicaciones o de los contenidos, incluyendo la URL o

vínculo a la Web del Real Instituto Elcano; así como cualquier uso comercial no

autorizado de los mismos o su reventa.</p>


<p>El Real Instituto Elcano no comparte necesariamente las opiniones manifestadas en los

documentos firmados por investigadores y colaboradores y difundidos en su Web o en

cualquier otra publicación del Real Instituto. El Instituto considera que su misión

fundamental es servir de foro de discusión y análisis, estimulando el debate y

recogiendo opiniones diversas sobre temas de la actualidad internacional, y muy

particularmente sobre aquellos que afecten a las relaciones internacionales de España y

su repercusión en los diferentes ámbitos de la sociedad española.</p>');
INSERT INTO translation VALUES ('Variable information desc TEXTO', 'Internet bandwidth (Mbps) and number of mentions in news of main international press agencies (Associated Press, Reuters, AFP, DPA, ITAR-TASS, EFE, ANSA, Xinhua)
...
INSERT INTO translation VALUES ('Bloques de países', 'Country blocs', 'Bloques de países');
INSERT INTO translation VALUES ('1 bloque', '1 bloc', '1 bloque');
INSERT INTO translation VALUES ('El bloque %s está compuesto por', 'For the year selected, the bloc %s is made up of', 'En el año seleccionado, el bloque %s está compuesto por');
INSERT INTO translation VALUES ('_faq text 1', 'The Index measures global presence. By global presence we understand the effective positioning, in absolute terms, of the different countries (products sold, tourists welcomed, victories in international sports competitions…)', 'Este Índice mide la presencia global. Por presencia global entendemos la proyección efectiva real de los países fuera de sus fronteras en los ámbitos económico, político y social (exportaciones realizadas, turistas recibidos, competiciones deportivas internacionales ganadas…)');
INSERT INTO translation VALUES ('_faq text 2', 'No. A country may have strong international projection and weak regional or global influence (or vice-versa). The relationship between presence and power depends on the foreign policy of each country or on the limiting factors of the exercise of influence depending, for instance, on the presence of another regional leader', 'No. Un país puede tener una alta proyección internacional pero una baja influencia regional o global. La relación entre presencia y poder dependerá, entre otros factores, de la política exterior de cada país (la voluntad de ejercer el poder) o de los limitantes al ejercicio de la influencia, dependiendo, por ejemplo, de la presencia de otro líder regional');
INSERT INTO translation VALUES ('_faq text 8', 'Weights assigned to variables and dimensions are based on experts’ criteria. Two surveys were conducted in 2012 and 2015: questionnaires were sent to specialists in international relations, and answers were combined to determine the weights of variables and dimensions', 'Los pesos asignados a variables y dimensiones están basados en el criterio de expertos. Se llevaron a cabo sendas encuestas, en 2012 y 2015, a un panel internacional de especialistas en relaciones internacionales cuyas respuestas se combinaron para determinar el peso de las variables y de las dimensiones');
INSERT INTO translation VALUES ('La <strong>presencia blanda</strong> se mide a través de lasmigraciones, el turismo, el rendimiento deportivo en competiciones internacionales, las patentesinternacionales, los artículos publicados en revistascientíficas, la ayuda al desarrollo, entre otros.', NULL, NULL);
INSERT INTO translation VALUES ('La <strong>presencia militar</strong> se mide con las tropasdesplegadas en el extranjero y con el equipamientomilitar.', NULL, NULL);
INSERT INTO translation VALUES ('La <strong>presencia económica</strong> se mide a través de lasexportaciones de energía, bienes primarios,manufacturas y servicios, así como las inversionesdirectas en el exterior.', NULL, NULL);
INSERT INTO translation VALUES ('Community manager y asistente web', 'Digital Communications Assistant & Community Manager', 'Asistente de Comunicación Digital y Community Manager');
...
<li>Iliana Olivié y Manuel Gracia, 2016,
...
INSERT INTO translation VALUES ('Ayudante de investigación', NULL, NULL);
INSERT INTO translation VALUES ('_faq text 10', 'For 1990, 1995, 2000, 2005, and 2010-16. Since 2010 the calculation is performed annually', 'Para 1990, 1995, 2000, 2005, y 2010-2016. Desde 2010, el cálculo es anual');
INSERT INTO translation VALUES ('Preguntas frecuentes sobre el Índice Elcano de Presencia Global', 'Frequently asked questions about Elcano Global Presence Index', 'Preguntas frecuentes sobre el Índice Elcano de Presencia Global');
