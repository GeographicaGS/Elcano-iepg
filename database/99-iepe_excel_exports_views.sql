...
create or replace view iepg_data_redux.vw__iepe_energy as
with names as(
  select
    a.name as iso,
    b.name as spanish
  ...
  from
    iepg_data_redux.iepe_data a inner join
    names b on
    a.code=b.iso
  order by code, year
), distinct_names as(
...
create or replace view iepg_data_redux.vw__iepe_primary_goods as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_manufactures as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_services as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_investments as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_troops as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_military_equipment as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_migrations as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_tourism as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_sports as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_culture as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_information as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_technology as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_science as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_education as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_cooperation as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_economic_presence as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_military_presence as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_soft_presence as
with names as(
  select
    a.name as iso,
    b.name as spanish
...
create or replace view iepg_data_redux.vw__iepe_iepe as
with names as(
  select
    a.name as iso,
    b.name as spanish
  ...
  select
    b.spanish, date_part('year', date_in) as year, iepe as data
  from
    iepg_data_redux.iepe_data a inner join
    names b on
    a.code=b.iso
