	...
	var Validation = (function(){
	  ...
	  var defaultCallbacks = Validation.callbacks = {
	    ...
	    valid: function(view, attr, selector) {
	          ...
	          .siblings("label.error_form").remove();
	  ...
	  var defaultValidators = Validation.validators = (function(){
	    ...
	    return {
	      ...
	      equalTo: function(value, attr, equalTo, model, computed) {
	    	...
	    	requiredGroup : function(value, attr, group, model) {
				if (!value ){
					var found = false;
					for (i=0;i<group.length;i++){
						if (model.get(group[i])){
							found =true;
							break;
						}
					}	
					if (!found){
						return this.format(defaultMessages.requiredGroup, this.formatLabel(attr, model));
					}
				}
			}
	    };
