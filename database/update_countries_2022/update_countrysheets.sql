...
-- European Union
UPDATE iepg_data_redux.iepg_comment
SET comment='<p>Si considerásemos a la Unión Europea un único país, tendría en 2021 un registro superior al de Estados Unidos y tres veces mayor que el de China, a pesar del Brexit y de la pandemia. Obtendría el mayor valor de presencia económica –con relevancia de la inversión en el exterior y las exportaciones de servicios– y de presencia blanda –turismo, educación, ciencia, deportes y cooperación al desarrollo–, siendo superado por Estados Unidos tan sólo en la clasificación de presencia militar.</p><p>La crisis económica de finales de los 2000, con especial impacto dentro del espacio comunitario, redujo la presencia de la Unión Europea en el resto del mundo. A partir de 2014 comenzó una leve tendencia de recuperación, drásticamente interrumpida con la pandemia y el Brexit. La pandemia ha tenido un fuerte impacto en su proyección blanda -especialmente por la interrupción del turismo- y, con la salida del Reino Unido, la Unión Europea ha perdido a un miembro caracterizado por una fuerte orientación extracomunitaria y un importante equipamiento militar.</p><br><p>Nota: El cálculo se realiza teniendo en cuenta la UE realmente existente en cada fecha, por lo que los datos entre 2005 se refieren a la UE-25, a partir de 2010 a la UE-27, a partir de 2013 a la UE-28, y desde 2021 la UE-27 tras la salida de Reino Unido.</p>'
