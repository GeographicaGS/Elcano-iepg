...
UPDATE www.translation SET en = 'The <a class=\"nostyle\" href=\"%s\"><strong>Elcano Global Presence Index</strong></a> is an annual measurement of the projection in the world of 120 countries based on three dimensions: | El <a class=\"nostyle\" href=\"%s\"><strong>Índice Elcano de Presencia Global</strong></a> calcula anualmente la proyección de 110 países fuera de sus fronteras en función de tres dimensiones:' WHERE key = '_home IEPG explora desc';
